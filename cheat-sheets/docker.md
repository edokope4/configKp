...
| docker logs | Muestra los logs de la salida estandar de lo que esté ejecutando un contenedor | docker logs nombre_de_el_contenedor -f |
...
| docker up | Comienza con la ejecución de un contenedor. Con el parámetro -d queda corriendo como demonio, en caso contrario, se ejecuta capturando la consola. | docker up nombre_container |
| | Modo Demonio. | docker up -d nombre_container | 
